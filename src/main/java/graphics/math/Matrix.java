...
public class Matrix {
    ...
    public Matrix minor(int excludeRowNum, int excludeColNum)
    {
        ...
        for (int rowNum = 0; rowNum < rows; rowNum++) {
            ...
            minorColNum = 0;
            for (int colNum = 0; colNum < cols; colNum++) {
                if (colNum == excludeColNum) continue;
    ...
    public double determinant() {
        ...
        // for larger matrices, calculate determinant using cofactor expansion along first row
        double det = 0;
        for (int colNum = 0; colNum < cols; colNum++) {
        ...
        for (int rowNum = 0; rowNum < rows; rowNum++) {
            for (int colNum = 0; colNum < cols; colNum++) {
                inv.values[rowNum][colNum] =
                    Math.pow(-1, rowNum + colNum) * this.minor(rowNum, colNum).determinant();
            }
        }
    ...
    public String toString() {
        ...
        for (int rowNum = 0; rowNum < rows; rowNum++) {
            s.append(getRow(rowNum).toString()).append("\n");
        }
        return s.toString();
    }
